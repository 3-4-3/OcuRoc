...
//            if ((data->markers[i].name == "WayPoint10") || (data->markers[i].name == "WayPoint9") || (data->markers[i].name == "WayPoint12") || (data->markers[i].name == "WayPoint23") || (data->markers[i].name == "WayPoint21") || (data->markers[i].name == "WayPoint22"))
//            if ((i != 0) && (i != 10) && (i != 9) && (i != 12) && (i != 23) && (i != 21) && (i != 22))
            {
